...
const getEnvironmentConfig = (): EnvironmentConfig => {
    ...
    // For client-side rendering, use window.location.host
    ...
    switch (host) {
        ...
        default:
            // Default configuration if no specific host matches
            return {
...
const environment: EnvironmentConfig = getEnvironmentConfig();
